...
const items = [
  ...
  },
  {
    ...
    image: 'https://lh3.googleusercontent.com/7ZFeNaod0-q0SuuAbg2I8ZXVNyU2XahVjpLzCXX7D_fNVUFYIKSjWdBHRaLOXUlF4zzM-mS62jQFaCzw1GhwF8jGFwTYV6dm7_1NxoA=s128'
  },
  {
    name: 'wilsonwei.eth',
    address: '0x8891075a34b58a53dddf50b8e200211ff470a580',
    image: 'https://lh3.googleusercontent.com/ZIKDovUfNyNFYH02_TSJr5WTW6eJj0-aozhJAIWYWU24G16FIyEIplWBjEh1WIHQseMd_yZg1gpIUcgzIR7Y7XMreP0zoO1oQKQgeQ=s128'
  },
  {
    name: 'zhimao.eth',
    address: '0x8ddd03b89116ba89e28ef703fe037ff77451e38e',
    image: 'https://lh3.googleusercontent.com/qsxnWQWDdIUW67jNYMSmVIbDQri367mRucU7dELJTG0hGBgy11UoaSYLAixy7vnuUqJhg7yhgW5fybts2gmcJd5dQcA7MYgXjRF0Qw=s128'
  },
  {
  ...
  },
  {
    ...
    image: 'https://lh3.googleusercontent.com/L6qMNQ8kf2yX61RlBMHwazZJ9OQOpDowVY3GWV40yn6fWbBApi3rYH0HIwVLAZMLok1Zwygrg6CcY1MNlgFQcwU_Dy2TbTM2zw3eR6Q=w600'
  },
  {
    name: 'nick.eth',
    address: '0xb8c2c29ee19d8307cb7255e1cd9cbde883a267d5',
    image: 'https://lh3.googleusercontent.com/hKHZTZSTmcznonu8I6xcVZio1IF76fq0XmcxnvUykC-FGuVJ75UPdLDlKJsfgVXH9wOSmkyHw0C39VAYtsGyxT7WNybjQ6s3fM3macE=s128'
  },
  {
    name: 'spadequeen7.eth',
    address: '0x5fd9b0b7e15b4d106624ea9cf96602996c9c344d',
    image: 'https://lh3.googleusercontent.com/IWNUt93gg5kwF3VodiYiy1IoVvjI87gqKaf0BYiqzlVRTzUf8WJksJxsYoeEH4aguzv_o8JjphvDXL1DdnUKqXsbk4y6Whoy9PITag=s128'
  },
  {
    name: 'akasuv.eth',
    address: '0xbd358966445e1089e3add528561719452fb78198',
    image: 'https://lh3.googleusercontent.com/9mGrAiuaK3qp0E2PHPt0BDARna7iA6svbQEYzMNM6YnuQkYeVJn_tdlMzIYT7QKTDRihgraYgQ_BFRZUPhIjUPnavEXj8ThqYnVu7vQ=s128'
  },
  {
    name: 'ivyli.eth',
    address: '0x1e25653ff9852119360c9f8d796969fafc048929',
    image: 'https://lh3.googleusercontent.com/MgnHOIOyPhyWkVmFrFXJ3Sb88gvHH-K4CWadkEIQdDNF7K_93-gwiloxcKWSQJ0HuYtW2qSu79als_PRiDr4noq5rnIRoSqcoA4weww=s128'
  },
  {
    name: 'peiwen.eth',
        ...
        <Link href={`/users/${i.address}`} passHref>
          <a>
            <Tooltip followCursor
              ...
              }}> <AtticcIcon tColor={'#fff'} oColor={'#fff'} borderColor={'#fff'} aColor={'#000'} cColor={'#000'} height={120} width={120} /></Avatar>
            </Tooltip>
          </a>
        </Link>
      </div>
      ...
      <Grid container direction="row" justifyContent={'space-around'} height={'50vh'} alignItems={'center'} pt={10}>
        <Grid item md={6}>
          <Grid container direction="column" px={3}>
            ...
            <Grid item pt={2}>
              <Button variant='outline' color='primary' href={'/discover'}>See More</Button>
            </Grid>
          </Grid>
        </Grid>
        <Grid item md={4}>
