...
export const GraphContextProvider: React.FC<any> = ({ children }) => {
  ...
  // const { data: identityData } = useIdentity({ address: selectAddress });
  ...
  // const identityData = queryClient.getQueryData(["identity", selectAddress])
  //   console.log(identityData)
  ...
  // const { fetchMore } = queryClient.getQueryData(["connections", {
