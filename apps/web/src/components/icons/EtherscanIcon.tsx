...
export const EtherscanIcon = (props: IIconProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={props.width === undefined ? '23' : props.width}
      height={props.height === undefined ? '21' : props.height} viewBox="0 0 293.775 293.667">
